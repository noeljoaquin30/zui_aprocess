			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zuiaprocess-display": {
								"semanticObject": "zuiaprocess",
								"action": "display",
								"description": "Assign and Process",
								"title": "Assign and Process",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zuiaprocess",
									"url": sap.ui.require.toUrl("zuiaprocess")
								}
							}
						}
					}
